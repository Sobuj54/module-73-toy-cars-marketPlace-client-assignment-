  ...
  return (
    <div className="bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 px-5 lg:px-10 py-14">
        ...
        <p className="space-y-3 text-lg">
          ...
          <article>
            ...
            <li>
              ...
              by the authorization server. The responsibility of refresh token
        ...
        <p className="space-y-4 text-lg">
          <article>
            ...
            <li>
              ...
              and it usually looks like ‘Bearer h090Yuuyuiyv’. It is verified by
              the APi, which the client is calling.
            </li>
            <li>
              Access token are usually in JWT format, but you can use any other
              format.
            </li>
            <li>
            ...
            <li>
              ...
              because they are not a place for any sensitive data. It is best to
          ...
          <article>
            ...
            <li>
              ...
              token when the existing access token is expired.
            </li>
            <li>
      ...
      <section className="mt-10">
        ...
        <p className="text-lg">
          Nest.JS is a framework for building efficient and scalable server-side
          applications using JavaScript or TypeScript. It is built on top of the
          widely popular Node.js runtime and leverages its asynchronous,
          event-driven nature to provide a robust and reliable platform for
      ...
      <section className="mt-10">
        ...
        <p className="text-lg">
          ...
          aggregation operations assemble values from various documents together
          and are able to execute a range of operations, such as average, sum,
          maximum, minimum, etc., on the assembled data to provide only a
          result.
        </p>
      </section>
      {/* 7 */}
      <section className="mt-10">
        ...
        <article className="text-lg">
          ...
          <p>
            ...
            the aggregation framework are as follows:
          </p>
          <br />
          <p>
            ...
            pre-joined and then this operation will be uncompleted with this to
            include distinct documents another time. Hence, with the help of
            this stage, we can increase the sum of documents for the succeeding
            stage.
          </p>
        </article>
      </section>
